...
export function DesignIntentui() {
  return (
    <div className="border-t bg-fg py-6 text-bg sm:py-24 dark:bg-fg/85">
      <Container>
        <div className="relative max-w-3xl">
          <h1 className="mt-4 mb-4 text-3xl sm:text-4xl lg:text-6xl">
          ...
          <div className="mt-6 flex flex-col gap-2 sm:mt-10 sm:flex-row sm:items-center">
            <Link
