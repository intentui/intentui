      ...
      <Drawer.Content>
        ...
        <Drawer.Body>
          <div className="prose prose-zinc dark:prose-invert">
            ...
            nature, should survive termination shall remain in effect. This includes, but
            is not limited to, ownership provisions, warranty disclaimers, and limitations
            of liability.
            ...
            any kind, whether express or implied. We do not warrant that our services will
            meet your requirements or that they will be error-free or secure.
