...
const NavLink = ({ href, isActive, className, isNextLink, ...props }: NavLinkProps) => {
  ...
  return (
    <El
      href={href}
      className={twMerge(
        "relative flex items-center gap-x-2 px-2 py-3 text-sm tracking-tight outline-hidden transition-colors focus:outline-hidden focus-visible:text-fg sm:py-3 **:[svg]:-mx-0.5",
