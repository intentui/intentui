        ...
        {(values) => (
          <>
            ...
            <span
              ...
              className="pointer-events-none relative ms-(--disclosure-gutter-x,--spacing(0)) -me-[calc(var(--disclosure-gutter-x,--spacing(0))-(--spacing(3)))] flex size-6 items-center justify-center"
            >
              <span
                className={twJoin([
