...
export const editorTheme: EditorThemeClasses = {
  ...
  tableCellActionButton:
    "EditorTheme__tableCellActionButton bg-overlay block border-0 rounded-2xl w-5 h-5 text-fg cursor-pointer",
