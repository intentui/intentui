  ...
  return (
    ...
    >
      <MenuPrimitive
        ...
        className={composeTailwindRenderProps(
          className,
          "grid max-h-96 grid-cols-[auto_1fr] overflow-y-scroll overscroll-contain p-1 outline-hidden [clip-path:inset(0_0_0_0_round_calc(var(--radius-lg)-2px))] *:[[role='group']+[role=group]]:mt-4 *:[[role='group']+[role=separator]]:mt-1",
        )}
        {...props}
      />
    </PopoverContent>
