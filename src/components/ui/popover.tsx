  ...
  return (
    <PopoverPrimitive
      ...
      className={composeTailwindRenderProps(
        className,
        twJoin([
          "group/popover max-h-[90dvh] min-w-(--trigger-width) max-w-xs overflow-y-auto rounded-xl border bg-overlay bg-clip-padding text-overlay-fg shadow-xs transition-transform [--gutter:--spacing(6)] sm:max-w-3xl sm:text-sm dark:backdrop-saturate-200",
