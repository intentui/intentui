  ...
  return (
    <PopoverPrimitive
      ...
      className={composeTailwindRenderProps(
        className,
        twJoin([
          "max-h-[90dvh] min-w-(--trigger-width) max-w-xs overflow-y-auto rounded-xl border bg-overlay bg-clip-padding text-overlay-fg shadow-xs transition-transform sm:max-w-3xl sm:text-sm dark:backdrop-saturate-200",
