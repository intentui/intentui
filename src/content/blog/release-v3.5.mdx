...
```tsx
<TextField label="Username" description="Enter your username" errorMessage="Username is required" />
```
...
```tsx
<Textarea label="Bio" description="Tell us about yourself" errorMessage="Bio is required" />
```
...
```tsx
<Select label="Country" description="Select your country" errorMessage="Country is required">
  <SelectContent />
</Select>
```
...
```tsx
<ComboBox label="City" description="Select your city" errorMessage="City is required">
  <ComboBoxContent />
</ComboBox>
```
...
Intent UI Design has been updated to match the latest components and patterns in this release. Enjoy **[35% off](https://design.intentui.com/pricing)** all templates and design assets for a limited time. One-time purchase, no subscription.
