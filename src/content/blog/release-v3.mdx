...
<How readMore="/toggle-group" toUse="buttons/toggle-group/toggle-group-example" />
...
<How readMore="/button" toUse="buttons/button/button-intent-example" />
...
We’ve improved the user experience on `Checkbox`, `CheckboxGroup`, and `RadioGroup` by allowing direct use of labels and descriptions inside them. Use `Label` for group labels, and `CheckboxLabel` or `RadioLabel` for item labels.
...
<How readMore="/checkbox-group" toUse="controls/checkbox-group/switch-description-example" />
...
<How readMore="/switch" toUse="controls/switch/switch-description-example" />
