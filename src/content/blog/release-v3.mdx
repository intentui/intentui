...
<How
  ...
  toUse="buttons/toggle-group/toggle-group-example" />
...
<How
  readMore='/button'
  toUse="buttons/button/button-intent-example" />
...
<How
  ...
  toUse="controls/checkbox-group/switch-description-example" />
...
<How
  readMore='/switch'
  toUse="controls/switch/switch-description-example" />
