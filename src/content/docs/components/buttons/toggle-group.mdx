---
title: "Toggle Group"
description: A toggle button group provides an intuitive way for users to switch between multiple options, supporting both single and multi-selection modes. It enhances UI flexibility.
order: 3
published: true
