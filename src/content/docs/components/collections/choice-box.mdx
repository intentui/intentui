---
title: "Choice Box"
description: A larger, more descriptive version of a radio or checkbox, with a generous tap target and room for supporting details to help users decide quickly.
order: 8
published: true
