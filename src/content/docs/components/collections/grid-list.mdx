...
Note that I haven't set an `id` for the grid list item as the items already have default IDs.
However, you should specify the `id` prop for each grid list item like this: ```
...
<How
  isCenter={false}
  withNoPadding
  toUse="collections/grid-list/grid-list-drag-between-item-example"
/>
