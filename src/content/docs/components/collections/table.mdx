...
<How isCenter={false} toUse="collections/table/table-demo" />
...
<How isCenter={false} toUse="collections/table/table-with-autocomplete-demo" />
...
<How isCenter={false} toUse="collections/table/table-resize-demo" />
...
<How isCenter={false} toUse="collections/table/table-infinite-scroll-demo" />
...
<How isCenter={false} toUse="surfaces/card/card-table-demo"/>
