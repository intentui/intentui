...
## Searchable
In the latest React Aria release, tables are now searchable because Autocomplete supports all collection types, including Table. This makes it possible for users to filter table rows directly through their input.
