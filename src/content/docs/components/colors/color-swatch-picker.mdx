...
description: A grid-based selection tool that presents a set of predefined colors for easy and consistent color choices. It allows for controlled selection and disabled states.
order: 5
published: true
