---
title: "Color Wheel"
description: A circular color selection tool that visualizes the full color spectrum for intuitive and precise color picking. It supports controlled values and disabled states.
order: 7
published: true
