...
<InstallCommand command="npx shadcn@latest add @intentui/input"/>
...
The `Input` component renders a styled text input.
...
The `InputGroup` component groups an input with adjacent controls.
