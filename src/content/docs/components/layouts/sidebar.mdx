...
<CodeSandbox
  src='/pre-blocks/sidebar/sidebar-01'
  source={{
    preview: 'pre-blocks/sidebar/sidebar-01/page',
...
### Fleet
The `fleet` variation removes horizontal padding from the items. Check out how it works in action: <NewTab href='/pre-blocks/sidebar/sidebar-18'/>
<EditorText
  source={{
    'folders.ts': 'pre-blocks/sidebar/sidebar-18/folders.ts',
    'sidebar-header.tsx': 'pre-blocks/sidebar/sidebar-18/sidebar-header',
    'app-sidebar.tsx': 'pre-blocks/sidebar/sidebar-18/app-sidebar',
    'layout.tsx': 'pre-blocks/sidebar/sidebar-18/layout',
    'page.tsx': 'pre-blocks/sidebar/sidebar-18/page',
  }} />
...
If you need to collapse multiple items, you can use the `SidebarDisclosureGroup` component. <NewTab href='/pre-blocks/sidebar/sidebar-10'/>
```
...
<CodeSandbox
  src='/pre-blocks/sidebar/sidebar-08'
  source={{
    preview: 'pre-blocks/sidebar/sidebar-08/page',
    'app-sidebar-nav.tsx': 'pre-blocks/sidebar/app-sidebar-nav',
    'app-sidebar.tsx': 'pre-blocks/sidebar/sidebar-08/app-sidebar',
    'layout.tsx': 'pre-blocks/sidebar/sidebar-08/layout',
    'page.tsx': 'pre-blocks/sidebar/sidebar-08/page',
  }} />
...
<CodeSandbox
  src='/pre-blocks/sidebar/sidebar-12'
  source={{
    preview: 'pre-blocks/sidebar/sidebar-12/page',
    'app-sidebar-nav.tsx': 'pre-blocks/sidebar/app-sidebar-nav',
    'app-sidebar.tsx': 'pre-blocks/sidebar/sidebar-12/app-sidebar',
    'layout.tsx': 'pre-blocks/sidebar/sidebar-12/layout',
    'page.tsx': 'pre-blocks/sidebar/sidebar-12/page',
  }} />
...
<Sidebar shortcut="1" />
```
The preview can be seen in the <NewTab href='/pre-blocks/sidebar/sidebar-10'>Sidebar Shortcut</NewTab> page.
