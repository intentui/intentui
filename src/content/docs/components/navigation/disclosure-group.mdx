...
<How
  ...
  toUse="navigation/disclosure-group/disclosure-group-default-expand-example"
/>
...
<How
  className="w-full max-w-sm"
  toUse="navigation/disclosure-group/disclosure-group-allow-multiple-expand-example"
/>
...
<How
  className="w-full max-w-sm"
  toUse="navigation/disclosure-group/disclosure-group-nested-example"
/>
...
<How
  className="w-full max-w-sm"
  toUse="navigation/disclosure-group/disclosure-group-with-icon-example"
/>
...
<How
  className="w-full max-w-sm"
  toUse="navigation/disclosure-group/disclosure-group-disabled-example"
/>
