...
<How className="w-full max-w-sm" toUse="navigation/disclosure-group/disclosure-group-border-hidden-demo" />

## Hide indicator
To remove the visual indicator (arrow), use standard Tailwind CSS classes.
<How className="w-full max-w-sm" toUse="navigation/disclosure-group/disclosure-group-hide-indicator-demo" />

## Hide everything
If you want to hide both the border and the indicator, use the `hideBorder` and `hideIndicator` props.
<How className="w-full max-w-sm" toUse="navigation/disclosure-group/disclosure-group-hide-everything-demo" />
