---
title: "Modal"
description: A Centered overlay that requires user interaction before returning to the main interface. It focuses attention on critical information or actions. Ideal for confirmations.
order: 1
published: true
