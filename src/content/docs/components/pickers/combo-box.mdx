---
title: "Combo Box"
description: An advanced dropdown component that allows users to search, filter, and select options dynamically for a smoother selection experience. It combines input and listbox functionality.
order: 1
published: true
