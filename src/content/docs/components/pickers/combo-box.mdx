...
<ComboBox placeholder="Select a user" label="Users">
  <ComboBoxInput />
  <ComboBoxList>
    <ComboBoxOption>John Lennon</ComboBoxOption>
    <ComboBoxOption>Paul McCartney</ComboBoxOption>
    <ComboBoxOption>George Harrison</ComboBoxOption>
    <ComboBoxOption>Ringo Starr</ComboBoxOption>
  </ComboBoxList>
</ComboBox>
```
...
<How minW72 toUse="pickers/combo-box/combo-box-detail-description-demo" />
