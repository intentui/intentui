---
title: "Select"
description: A customizable dropdown menu that lets users choose a single option from a predefined list, optimized for accessibility and usability. It supports sections, icons, and validation.
order: 2
published: true
