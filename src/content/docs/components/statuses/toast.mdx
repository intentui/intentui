...
<InstallCommand command="npx shadcn@latest add @intentui/toast" />

## Manual installation

Use this approach if you prefer to install and wire up the component yourself instead of using the CLI.

<InstallCommand command="npm i sonner tailwind-merge" />
...
<InstallCommand command="npm i next-themes" />
...
The `Toast` component renders the app-level toast container.
