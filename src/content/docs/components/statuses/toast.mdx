...
## CSS variables
If you want your toast to look good, you’ll need to add some CSS variables to your theme.
<CodeBlock
  source={{
    'toast.css': 'installation/toast.css',
    'main.css': 'installation/main.css',
  }} />

## Manual installation
<Installation options={{ isManual: true }} items={['sonner']}/>
