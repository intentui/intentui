---
title: "Card"
description: A flexible UI container that groups related content, actions, and media in a structured and visually appealing layout. It includes headers, footers, and actions for comprehensive content display.
published: true
order: 1
---
## Basic
