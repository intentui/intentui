---
title: "Show More"
description: An expandable UI component that reveals hidden content on demand, optimizing space while maintaining accessibility. It can be used as button or text with orientation options.
order: 4
published: true
