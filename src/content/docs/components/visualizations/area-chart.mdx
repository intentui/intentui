...
<How
  withNoPadding
  isCenter={false}
  toUse="visualizations/area-chart/area-chart-custom-format-example"
/>
...
<How
  withNoPadding
  isCenter={false}
  toUse="visualizations/area-chart/area-chart-custom-tooltip-example"
/>
...
<How
  withNoPadding
  isCenter={false}
  toUse="visualizations/area-chart/area-chart-custom-legend-example"
/>
...
<How
  withNoPadding
  isCenter={false}
  toUse="visualizations/area-chart/area-chart-custom-colors-example"
/>
...
<How
  withNoPadding
  isCenter={false}
  toUse="visualizations/area-chart/area-chart-controlled-example"
/>
