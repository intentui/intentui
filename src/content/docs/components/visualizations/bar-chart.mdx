...
<Installation options={{ isComponent: true }} items={['bar-chart']} />
...
<How withNoPadding={true} isCenter={false} toUse="visualizations/bar-chart/bar-chart-stacked-demo" />


## Percent

Percent bar charts show how each category contributes proportionally to a whole, with each bar always totaling 100%.

<How withNoPadding={true} isCenter={false} toUse="visualizations/bar-chart/bar-chart-percent-demo" />
...
<How withNoPadding={true} isCenter={false} toUse="visualizations/bar-chart/bar-chart-custom-format-demo" />
...
<How withNoPadding={true} isCenter={false} toUse="visualizations/bar-chart/bar-chart-custom-tooltip-demo" />

## Custom legend

Custom legends help identify bar categories with icons, colors, or labels tailored to your dataset.

<How withNoPadding={true} isCenter={false} toUse="visualizations/bar-chart/bar-chart-custom-legend-demo" />

## Custom colors
Custom colors allow you to set specific colors for each bar, enhancing visual distinction and brand alignment.
<How withNoPadding={true} isCenter={false} toUse="visualizations/bar-chart/bar-chart-custom-colors-demo" />
...
<How withNoPadding={true} isCenter={false} toUse="visualizations/bar-chart/bar-chart-controlled-demo" />
