...
<How isCenter={false} withNoPadding toUse="visualizations/bar-chart/bar-chart-stacked-demo" />
...
<How isCenter={false} withNoPadding toUse="visualizations/bar-chart/bar-chart-custom-format-demo" />
...
<How isCenter={false} withNoPadding toUse="visualizations/bar-chart/bar-chart-custom-tooltip-demo" />

### Custom legend

Custom legends help identify bar categories with icons, colors, or labels tailored to your dataset.

<How isCenter={false} withNoPadding toUse="visualizations/bar-chart/bar-chart-custom-legend-demo" />

### Custom colors
Custom colors allow you to set specific colors for each bar, enhancing visual distinction and brand alignment.
<How isCenter={false} withNoPadding toUse="visualizations/bar-chart/bar-chart-custom-colors-demo" />
...
<How isCenter={false} withNoPadding toUse="visualizations/bar-chart/bar-chart-controlled-demo" />
