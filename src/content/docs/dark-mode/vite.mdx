---
title: Vite
description: Got a Vite project? Let's flip the switch to dark mode and get that cool, sleek look in a snap. This guide provides step-by-step instructions for integrating dark mode.
order: 1
published: true
---
