---
title: "Installation"
description: Install the necessary packages and set up your project. This tool automates the process, streamlining your setup with no extra steps required. Save time on configuration.
order: 2
published: true
---
