...
[issues](https://github.com/intentui/intentui/issues) and
[pull requests](https://github.com/intentui/intentui/pulls). For large features
or breaking changes, open an issue first so we can agree on the direction.

The repository's
[CONTRIBUTING.md](https://github.com/intentui/intentui/blob/main/CONTRIBUTING.md)
...
[MIT License](https://github.com/intentui/intentui/blob/main/LICENSE).
