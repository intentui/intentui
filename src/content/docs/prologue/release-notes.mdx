...
- The sidebar component is completely revamped
- Tooltip now remove `intent='inverse`, instead if you want to use inverse, just add `inverse` prop to `TooltipContent`.
